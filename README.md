...
따라서 사용자는 개별 제품을 일일이 조회하지 않고 CLI 명령어를 통해 제품 간의 장단점과 사용자 반응을 한눈에 비교할 수 있습니다.

#### 지원 및 테스트 범위

| 테스트 항목 | 비교 대상 | 분석 지표 | 결과 |
| --- | --- | --- | :---: |
| 특정 제품 비교 | 머그컵 vs 텀블러 | 리뷰 수, 평균 별점, 감정 비율, AI 요약 | ✅ |
| 전체 제품 비교 | DB 내 전체 등록 제품 | 제품별 종합 지표 및 순위 비교 | ✅ |
| 감정 분석 반영 | 긍정·중립·부정 리뷰 | AI 감정 분석 결과의 제품별 비율 계산 | ✅ |
| AI 키워드 추출 | 다수 제품 리뷰 본문 | 제품별 주요 긍·부정 키워드 및 요약 생성 | ✅ |
